...
import { useIsMobile } from "@/modules/shadcnui/hooks/use-mobile"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@/modules/shadcnui/components/ui/sheet"
...
// FIX: shadcn CLI v3.8.5 generates w-[--var] (v3 bracket syntax) which produces
// invalid CSS in Tailwind v4. Changed to w-(--var) (v4 parentheses syntax).
// If you re-run `npx shadcn@latest add sidebar`, re-apply this fix.
