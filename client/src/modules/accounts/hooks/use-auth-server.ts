...
import { AuthContext } from '../providers/auth-provider-server';
import type { AuthContextType } from '../providers/auth-provider-server';
...
export function useAuth() {
  ...
  return {
    ...
    // Password reset actions (stateless - imported directly)
    forgotPassword,
    resetPassword,
